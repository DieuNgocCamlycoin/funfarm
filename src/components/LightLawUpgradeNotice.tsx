...
import { Heart, Sparkles, X, ArrowRight, Gift } from 'lucide-react';
...
export const LightLawUpgradeNotice = ({ onDismiss }: LightLawUpgradeNoticeProps) => {
  ...
  return (
    <div className="relative overflow-hidden rounded-2xl bg-gradient-to-r from-primary/20 via-accent/20 to-primary/20 border-2 border-primary/40 p-4 md:p-6 shadow-lg animate-in fade-in slide-in-from-top-2 duration-500">
      {/* Sparkle decorations */}
      ...
      <div className="flex flex-col md:flex-row items-center gap-4">
        ...
        <div className="flex-1 text-center md:text-left">
          <h3 className="text-lg md:text-xl font-bold text-foreground flex items-center justify-center md:justify-start gap-2">
            <span>Bà con ơi</span>
        ...
        <div className="flex-shrink-0">
          <Button
            ...
            className="gradient-hero border-0 gap-2 shadow-lg hover:shadow-xl transition-shadow group"
            size="lg"
          >
