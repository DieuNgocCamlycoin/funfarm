  ...
  <DialogPortal>
    ...
    <DialogPrimitive.Content
      ...
      className={cn(
        ...
        // Mobile: full screen with proper positioning
        "left-0 right-0 top-0 bottom-0 max-w-none rounded-none",
        // Desktop: centered modal with proper centering
        "sm:left-1/2 sm:top-1/2 sm:right-auto sm:bottom-auto sm:max-w-lg sm:-translate-x-1/2 sm:-translate-y-1/2 sm:rounded-lg sm:p-6",
